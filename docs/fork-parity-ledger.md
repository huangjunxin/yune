...
Use this table before deciding whether to port a fork change. The ledger tracks
behavior Yune must preserve or decline; it does **not** imply that Yune should
copy the librime or fork implementation shape.
