...
- `docs/plans/m11-design-ai-native.md` and `docs/plans/archive/m13-plan-ai-native-frontend-exposure.md` are read before implementation.
...
- `docs/plans/m11-design-ai-native.md`: source of truth for AI architecture and invariants.
- `docs/plans/archive/m13-plan-ai-native-frontend-exposure.md`: source of truth for existing TypeDuck-Web AI exposure and safety evidence.
...
- Move when complete: `docs/plans/m32-plan-ai-native-public-demo-product-layer.md` to `docs/plans/archive/`
