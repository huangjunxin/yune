...
> **Audience.** An executing agent. Slice **S1** of the AI-native layer ([design](../m11-design-ai-native.md)): the minimal, source-labeled, non-blocking, off-by-default AI candidate path in the CLI. Delivers **AI-01, AI-03, AI-07** — **plus three cheap, safety-critical enforcement fixes the design review promoted into S1** (userdb-leak gate, commit-boundary no-auto-commit, single merge function). Revised after the judge-panel review.
>
...
_Draft 2026-06-18, revised after the judge-panel design review. First slice of the AI-native layer ([design](../m11-design-ai-native.md)); delivers AI-01/03/07 + the promoted safety gates; parallel-safe with M9/M10._
