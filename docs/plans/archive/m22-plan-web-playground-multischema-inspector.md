...
- **TypeDuck profile artifacts already proven (parallel oracle).** M19 onboards upstream `cangjie5` and `luna_pinyin` parity against the `1.17.0` oracle (`docs/plans/archive/m19-plan-breadth-schemas.md`). M22 reuses those provenance-stamped schema/dictionary identities for the browser bundle; it does **not** reopen M19 capture.
