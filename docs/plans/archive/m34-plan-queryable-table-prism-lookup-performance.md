...
- Move on completion: `docs/plans/m34-plan-queryable-table-prism-lookup-performance.md` to `docs/plans/archive/`
...
- The active plan moves to `docs/plans/archive/` only at closeout.
