...
This is the M9 counterpart to the parked [`m10-reference-typeduck-windows-contract.md`](../m10-reference-typeduck-windows-contract.md). Per web-first sequencing ([`../../roadmap.md`](../../roadmap.md)), finish this **before** resuming the TypeDuck-Windows native work.
