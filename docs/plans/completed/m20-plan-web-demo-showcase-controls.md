...
git add docs/plans/completed/m20-plan-web-demo-showcase-controls.md docs/roadmap.md docs/requirements.md
...
When complete, archive this plan under `docs/plans/completed/` with a scoped docs commit.
