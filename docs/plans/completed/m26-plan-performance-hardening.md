...
- Archive when complete: `docs/plans/completed/m26-plan-performance-hardening.md`
...
- Move this plan to `docs/plans/completed/m26-plan-performance-hardening.md` only after evidence and gates pass.
