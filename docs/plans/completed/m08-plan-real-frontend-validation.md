...
- TypeDuck-Web validation: `fixtures/frontend-traces/typeduck-web-basic.json`, `docs/plans/completed/frontend-validation/m08-record-typeduck-web.md`, and `.planning/phases/06-real-frontend-validation-and-benchmark/06-02-SUMMARY.md` preserve the browser/WebAssembly wrapper-shaped path and browser-only limits.
- Squirrel/macOS and Linux validation scope: `fixtures/frontend-traces/squirrel-lifecycle.json`, `docs/plans/completed/frontend-validation/m08-record-squirrel-macos.md`, `docs/plans/completed/frontend-validation/m08-record-linux-frontends.md`, and `.planning/phases/06-real-frontend-validation-and-benchmark/06-03-SUMMARY.md` preserve the native frontend blocker and follow-up trail.
- Frontend benchmark baselines: `docs/plans/completed/frontend-validation/m08-record-frontend-benchmark-baselines.md` records ABI-observed session, `RimeProcessKey`, deploy/dictionary, and userdb/sync measurements.
- AI-native readiness: `docs/plans/completed/frontend-validation/m08-record-ai-native-readiness.md` records the Phase 6 `GO WITH CONDITIONS` recommendation for beginning AI-native candidate/ranking design without implementing providers, rankers, context policy, memory policy, or privacy controls.
